            ...
            {contentState.updateChrome && (
                <div className="popup-warning">
                    ...
                    <div className="popup-warning-middle">
                        <div className="popup-warning-title">{chrome.i18n.getMessage('customAreaRecordingDisabledTitle')}</div>
                        <div className="popup-warning-description">{chrome.i18n.getMessage('customAreaRecordingDisabledDescription')}</div>
                    </div>
          ...
          <div className="popup-warning-right">
            ...
            {!cropActive && contentState.recordingType === 'region' && !contentState.offline && (
                <div className="popup-warning">
                    ...
                    <div className="popup-warning-right">
                        <a href="https://support.google.com/chrome/answer/95414?hl=en-GB&co=GENIE.Platform%3DDesktop" target="_blank">
                            {chrome.i18n.getMessage('customAreaRecordingDisabledAction')}
                        </a>
                    </div>
                </div>
            ...
            <button
                ...
                disabled={
                    ...
                    ((!contentState.cameraPermission || !contentState.cameraActive) && contentState.recordingType === 'camera')
                }
            >
