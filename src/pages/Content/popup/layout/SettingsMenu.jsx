...
const SettingsMenu = (props) => {
        ...
        if (typeof contentState.openModal === 'function') {
            contentState.openModal(
                ...
                () => {
                    ...
                    let platformInfo = {};
                    chrome.runtime.sendMessage({ type: 'get-platform-info' }).then((response) => {
    ...
    return (
        ...
        >
            ...
            <DropdownMenu.Portal container={props.shadowRef.current.shadowRoot.querySelector('.container')}>
                <DropdownMenu.Content className="DropdownMenuContent" sideOffset={5}>
                    ...
                    >
                        ...
                        <DropdownMenu.Portal>
                            <DropdownMenu.SubContent className="ScreenityDropdownMenuContent" sideOffset={0} alignOffset={-3}>
                                <TooltipWrap content={width < 3840 || height < 2160 ? chrome.i18n.getMessage('screenTooSmallTooltip') : ''}>
                                    <DropdownMenu.Item
                                ...
                                <TooltipWrap content={width < 1920 || height < 1080 ? chrome.i18n.getMessage('screenTooSmallTooltip') : ''}>
                                    <DropdownMenu.Item
                                        className="ScreenityDropdownMenuItem"
                                        onClick={(e) => {
                                            chrome.runtime.sendMessage({
                                ...
                                <TooltipWrap content={width < 1280 || height < 720 ? chrome.i18n.getMessage('screenTooSmallTooltip') : ''}>
                                    <DropdownMenu.Item
                                        className="ScreenityDropdownMenuItem"
                                        onClick={(e) => {
                                            chrome.runtime.sendMessage({
                                ...
                                <TooltipWrap content={width < 640 || height < 480 ? chrome.i18n.getMessage('screenTooSmallTooltip') : ''}>
                                    <DropdownMenu.Item
                                        className="ScreenityDropdownMenuItem"
                                        onClick={(e) => {
                                            chrome.runtime.sendMessage({
                                ...
                                <TooltipWrap content={width < 480 || height < 360 ? chrome.i18n.getMessage('screenTooSmallTooltip') : ''}>
                                    <DropdownMenu.Item
                                        className="ScreenityDropdownMenuItem"
                                        onClick={(e) => {
                                            chrome.runtime.sendMessage({
                                ...
                                <TooltipWrap content={width < 320 || height < 240 ? chrome.i18n.getMessage('screenTooSmallTooltip') : ''}>
                                    <DropdownMenu.Item
                                        className="ScreenityDropdownMenuItem"
                                        onClick={(e) => {
                                            chrome.runtime.sendMessage({
                    ...
                    >
                        <DropdownMenu.SubTrigger className="DropdownMenuItem">
                            {chrome.i18n.getMessage('maxResolutionLabel') + ' (' + contentState.qualityValue + ')'}
                            <div className="ItemIndicatorArrow">
                                <img src={DropdownGroup} />
                            </div>
                        </DropdownMenu.SubTrigger>
                        <DropdownMenu.Portal>
                            <DropdownMenu.SubContent className="ScreenityDropdownMenuContent" sideOffset={0} alignOffset={-3}>
                                ...
                                >
                                    <TooltipWrap
                                        content={
                                            RAM < 8 || width < 3840 || height < 2160 ? chrome.i18n.getMessage('maxResolutionTooltip') : ''
                                        }
                                    >
                                    ...
                                    <TooltipWrap
                                        content={
                                            RAM < 4 || width < 1920 || height < 1080 ? chrome.i18n.getMessage('maxResolutionTooltip') : ''
                                        }
                                    >
                                        <DropdownMenu.RadioItem
                                            className="ScreenityDropdownMenuItem"
                                    ...
                                    <TooltipWrap
                                        content={
                                            RAM < 2 || width < 1280 || height < 720 ? chrome.i18n.getMessage('maxResolutionTooltip') : ''
                                        }
                                    >
                                        <DropdownMenu.RadioItem
                                            className="ScreenityDropdownMenuItem"
