...
const Modal = (props) => {
    ...
    return (
        ...
        >
            ...
            <AlertDialog.Portal container={props.shadowRef.current.shadowRoot.querySelector('.container')}>
                    ...
                    <div style={{ display: 'flex', gap: 12, justifyContent: 'flex-end' }}>
                        ...
                        {button1 && (
                            <AlertDialog.Action asChild>
                                <button className={!colorSafe ? 'Button red' : 'Button blue'} onClick={() => trigger()}>
                                    {button1}
                                </button>
                            </AlertDialog.Action>
                        )}
