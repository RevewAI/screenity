...
const ContentState = (props) => {
    ...
    useEffect(() => {
        ...
        } else if (contentState.alarm && !contentState.paused && contentState.recording && contentState.timer > 0) {
            const interval = setInterval(() => {
                setTimer((timer) => timer - 1);
            }, 1000);
            return () => clearInterval(interval);
    ...
    const onMessage = useCallback(
        ...
        async (request, sender, sendResponse) => {
            if (request.type === 'time') {
                ...
                if (!contentStateRef.current.showPopup && !contentStateRef.current.pendingRecording) {
                    setContentState((prevContentState) => ({
                        ...prevContentState,
                        showExtension: false,
                        recording: false,
                ...
                const startRecordingCommand = request.commands.find((command) => command.name === 'start-recording');
                const cancelRecordingCommand = request.commands.find((command) => command.name === 'cancel-recording');
                setContentState((prevContentState) => ({
                    ...prevContentState,
    ...
    useEffect(() => {
        const checkRAM = () => {
            ...
            if (
                ...
                (contentState.qualityValue === '720p' || contentState.qualityValue === '4k' || contentState.qualityValue === '1080p')
            ) {
                setContentState((prevContentState) => ({
                    ...prevContentState,
                    qualityValue: '480p'
            ...
            } else if ((ram < 8 || width < 3840 || height < 2160) && contentState.qualityValue === '4k') {
                setContentState((prevContentState) => ({
                    ...prevContentState,
                    qualityValue: '720p'
                }));
    ...
    }, [contentState.parentRef, contentState.shadowRef, contentState.bigTab, contentState.recordingType]);
        ...
        chrome.storage.local.get(
            ...
            (result) => {
                ...
                setContentState((prevContentState) => ({
                    ...prevContentState,
                    audioInput:
                        result.audioInput !== undefined && result.audioInput !== null ? result.audioInput : prevContentState.audioInput,
                    videoInput:
                        result.videoInput !== undefined && result.videoInput !== null ? result.videoInput : prevContentState.videoInput,
                    defaultAudioInput:
                    ...
                    micActive: result.micActive !== undefined && result.micActive !== null ? result.micActive : prevContentState.micActive,
                    backgroundEffect:
                    ...
                    countdown: result.countdown !== undefined && result.countdown !== null ? result.countdown : prevContentState.countdown,
                    recording: result.recording !== undefined && result.recording !== null ? result.recording : prevContentState.recording,
                    recordingType:
                    ...
                    regionWidth:
                        result.regionWidth !== undefined && result.regionWidth !== null ? result.regionWidth : prevContentState.regionWidth,
                    regionHeight:
                        result.regionHeight !== undefined && result.regionHeight !== null
                            ? result.regionHeight
                            : prevContentState.regionHeight,
                    regionX: result.regionX !== undefined && result.regionX !== null ? result.regionX : prevContentState.regionX,
                    regionY: result.regionY !== undefined && result.regionY !== null ? result.regionY : prevContentState.regionY,
                    hideToolbar:
                        result.hideToolbar !== undefined && result.hideToolbar !== null ? result.hideToolbar : prevContentState.hideToolbar,
                    alarm: result.alarm !== undefined && result.alarm !== null ? result.alarm : prevContentState.alarm,
                    alarmTime: result.alarmTime !== undefined && result.alarmTime !== null ? result.alarmTime : prevContentState.alarmTime,
                    pendingRecording:
                    ...
                    cursorMode:
                        result.cursorMode !== undefined && result.cursorMode !== null ? result.cursorMode : prevContentState.cursorMode,
                    pushToTalk:
                        result.pushToTalk !== undefined && result.pushToTalk !== null ? result.pushToTalk : prevContentState.pushToTalk,
                    zoomEnabled:
                        result.zoomEnabled !== undefined && result.zoomEnabled !== null ? result.zoomEnabled : prevContentState.zoomEnabled,
                    askMicrophone:
                    ...
                    setDevices:
                        result.setDevices !== undefined && result.setDevices !== null ? result.setDevices : prevContentState.setDevices,
                    popupPosition:
                        result.popupPosition !== undefined && result.popupPosition !== null
                            ? result.popupPosition
                            : prevContentState.popupPosition,
                    surface: result.surface !== undefined && result.surface !== null ? result.surface : prevContentState.surface,
                    hideUIAlerts:
                        result.hideUIAlerts !== undefined && result.hideUIAlerts !== null
                            ? result.hideUIAlerts
                            : prevContentState.hideUIAlerts,
                    hideUI: result.hideUI !== undefined && result.hideUI !== null ? result.hideUI : prevContentState.hideUI,
                    bigTab: result.bigTab !== undefined && result.bigTab !== null ? result.bigTab : prevContentState.bigTab,
                    toolbarHover:
                        result.toolbarHover !== undefined && result.toolbarHover !== null
                            ? result.toolbarHover
                            : prevContentState.toolbarHover,
                    askDismiss:
                        result.askDismiss !== undefined && result.askDismiss !== null ? result.askDismiss : prevContentState.askDismiss,
                    swatch: result.swatch !== undefined && result.swatch !== null ? result.swatch : prevContentState.swatch,
                    color: result.color !== undefined && result.color !== null ? result.color : prevContentState.color,
                    strokeWidth:
                        result.strokeWidth !== undefined && result.strokeWidth !== null ? result.strokeWidth : prevContentState.strokeWidth,
                    quality: result.quality !== undefined && result.quality !== null ? result.quality : prevContentState.quality,
                    systemAudio:
                        result.systemAudio !== undefined && result.systemAudio !== null ? result.systemAudio : prevContentState.systemAudio,
                    backup: result.backup !== undefined && result.backup !== null ? result.backup : prevContentState.backup,
                    backupSetup:
                        result.backupSetup !== undefined && result.backupSetup !== null ? result.backupSetup : prevContentState.backupSetup,
                    qualityValue:
                        result.qualityValue !== undefined && result.qualityValue !== null
                            ? result.qualityValue
                            : prevContentState.qualityValue,
                    fpsValue: result.fpsValue !== undefined && result.fpsValue !== null ? result.fpsValue : prevContentState.fpsValue
                }));
