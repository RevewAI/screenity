...
import { ReEvalUpload } from './ReEvalUpload';
                ...
                <div>
                    {!contentState.fallback && contentState.offline && (
                        <div className={styles.alert}>
                            ...
                            <div className={styles.buttonMiddle}>
                                <div className={styles.buttonTitle}>{chrome.i18n.getMessage('offlineLabelTitle')}</div>
                                <div className={styles.buttonDescription}>{chrome.i18n.getMessage('offlineLabelDescription')}</div>
                            </div>
                            <div className={styles.buttonRight}>{chrome.i18n.getMessage('offlineLabelTryAgain')}</div>
                        </div>
                    )}
                    {contentState.fallback && (
                        <div className={styles.alert}>
                            ...
                            <div className={styles.buttonMiddle}>
                                <div className={styles.buttonTitle}>{chrome.i18n.getMessage('recoveryModeTitle')}</div>
                                <div className={styles.buttonDescription}>{chrome.i18n.getMessage('overLimitLabelDescription')}</div>
                            </div>
                        </div>
                    )}
                    {!contentState.fallback &&
                        ...
                        contentState.duration <= contentState.editLimit && (
                            <div className={styles.alert}>
                                ...
                                <div className={styles.buttonMiddle}>
                                    <div className={styles.buttonTitle}>{chrome.i18n.getMessage('updateChromeLabelTitle')}</div>
                                    <div className={styles.buttonDescription}>{chrome.i18n.getMessage('updateChromeLabelDescription')}</div>
                                </div>
                                <div
                    ...
                    {!contentState.fallback &&
                        ...
                        !contentState.updateChrome && (
                            <div className={styles.alert}>
                                ...
                                <div className={styles.buttonMiddle}>
                                    <div className={styles.buttonTitle}>{chrome.i18n.getMessage('overLimitLabelTitle')}</div>
                                    <div className={styles.buttonDescription}>{chrome.i18n.getMessage('overLimitLabelDescription')}</div>
                                </div>
                                <div
                                    className={styles.buttonRight}
                    ...
                    {(!contentState.mp4ready || contentState.isFfmpegRunning) &&
                        ...
                        !contentState.noffmpeg && (
                            <div className={styles.alert}>
                                ...
                                <div className={styles.buttonMiddle}>
                                    <div className={styles.buttonTitle}>{chrome.i18n.getMessage('videoProcessingLabelTitle')}</div>
                    ...
                    <div className={styles.section}>
                        <div className={styles.sectionTitle}>{chrome.i18n.getMessage('sandboxEditTitle')}</div>
                        <div className={styles.buttonWrap}>
                            ...
                            >
                                ...
                                <div className={styles.buttonMiddle}>
                                    <div className={styles.buttonTitle}>{chrome.i18n.getMessage('editButtonTitle')}</div>
                                    <div className={styles.buttonDescription}>
                            ...
                            >
                                ...
                                <div className={styles.buttonMiddle}>
                                    <div className={styles.buttonTitle}>{chrome.i18n.getMessage('cropButtonTitle')}</div>
                                    <div className={styles.buttonDescription}>
                                        {contentState.offline && !contentState.ffmpegLoaded
                                            ? chrome.i18n.getMessage('noConnectionLabel')
                                            : contentState.updateChrome ||
                            ...
                            >
                                ...
                                <div className={styles.buttonMiddle}>
                                    <div className={styles.buttonTitle}>{chrome.i18n.getMessage('addAudioButtonTitle')}</div>
                                    <div className={styles.buttonDescription}>
                                        {contentState.offline && !contentState.ffmpegLoaded
                                            ? chrome.i18n.getMessage('noConnectionLabel')
                                            : contentState.updateChrome ||
                    ...
                    <div className={styles.section}>
                        <div className={styles.sectionTitle}>{chrome.i18n.getMessage('sandboxSaveTitle')}</div>
                    ...
                    <div className={styles.section}>
                        <div className={styles.sectionTitle}>{chrome.i18n.getMessage('sandboxExportTitle')}</div>
                        <div className={styles.buttonWrap}>
                            {contentState.fallback && (
                                <div
                                    role="button"
                            ...
                            <div
                                ...
                                disabled={
                                    contentState.isFfmpegRunning || contentState.noffmpeg || !contentState.mp4ready || contentState.noffmpeg
                                }
                            >
                                <div className={styles.buttonLeft}>
                                    <ReactSVG src={URL + 'editor/icons/download.svg'} />
                    ...
                    <div className={styles.section}>
                        ...
                        <div className={styles.sectionTitle}>{chrome.i18n.getMessage('sandboxAdvancedTitle')}</div>
                        <div className={styles.buttonWrap}>
                            <div
                                role="button"
                                className={styles.button}
                            ...
                            >
                                ...
                                <div className={styles.buttonMiddle}>
                                    <div className={styles.buttonTitle}>{chrome.i18n.getMessage('rawRecordingButtonTitle')}</div>
                                    <div className={styles.buttonDescription}>
                            ...
                            >
                                ...
                                <div className={styles.buttonMiddle}>
                                    <div className={styles.buttonTitle}>{chrome.i18n.getMessage('troubleshootButtonTitle')}</div>
                                    <div className={styles.buttonDescription}>
